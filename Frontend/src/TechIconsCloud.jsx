...
const icons = [
  ...
  { name: "nuxt", size: 40, x: "90vw", y: "30vh" },
  { name: "swift", size: 38, x: "75vw", y: "48vh" },
  { name: "vuejs", size: 40, x: "87vw", y: "47vh" },
